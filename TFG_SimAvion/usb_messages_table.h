...
typedef struct {
    int IndexMR;
} PACKED  PARAM_MENSAJE_HUMRESOLUCION; //defino el parametro para cambiar el valor de resolucion de medida de la humedad
...
typedef struct {
    int IndexDLPF;
} PACKED  PARAM_MENSAJE_DLPFMOV; //defino el parametro para cambiar el valor del Digital Low Pass Filter del movimiento
